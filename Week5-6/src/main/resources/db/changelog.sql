...
-- changeset pastaposta:addTaskTime
INSERT INTO USERS (ID, EMAIL, PASSWORD, FIRST_NAME, DISPLAY_NAME)
VALUES (100, 'test_user@gmail.com', '{noop}password', 'Test', 'Tester')
ON CONFLICT (ID) DO NOTHING;

INSERT INTO PROJECT (ID, CODE, TITLE, DESCRIPTION, TYPE_CODE)
VALUES (100, 'PRJ-100', 'Test Project', 'Desc', 'scrum')
ON CONFLICT (ID) DO NOTHING;

INSERT INTO TASK (ID, TITLE, TYPE_CODE, STATUS_CODE, PROJECT_ID)
VALUES (100, 'Test Task', 'task', 'todo', 100)
ON CONFLICT (ID) DO NOTHING;

INSERT INTO ACTIVITY (AUTHOR_ID, TASK_ID, UPDATED, STATUS_CODE)
VALUES
    (100, 100, '2026-02-20 10:00:00', 'in_progress'),
    (100, 100, '2026-02-25 10:00:00', 'ready_for_review'),
    (100, 100, '2026-02-27 10:00:00', 'done');